  ...
  return (
    <PageShell className="max-w-5xl">
      <PageHeader
        ...
        title="Politique de confidentialité"
        description="Cette politique a pour objet d’informer les visiteurs du site sur la manière dont leurs données personnelles sont collectées, utilisées, conservées et protégées."
      />
