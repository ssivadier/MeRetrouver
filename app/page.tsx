      ...
      <Reveal>
        <section className="page-section flex flex-col gap-10 backdrop-blur">
          <div className="space-y-6">
            <p className="font-display text-2xl italic leading-relaxed text-brand-deep">
            ...
            <p className="text-base leading-8 text-brand-ink/80">
              Vous sentez des tensions dans votre corps, votre coeur qui s&apos;emballe, votre sommeil érratique, des reflux acides. Vous avez l&apos;impression que vous ne faites que <span className="highlight-gold">tenir le coup</span>.
              <br /><br />
        ...
        <section className="page-section flex flex-col gap-10 backdrop-blur">
          <div className="space-y-6">
            ...
            <p className="text-base leading-7 text-brand-ink/80">
              Notre approche n&apos;est pas sur les symptomes, comme le sont les médicaments, mais sur la cause du stress.
              <br /><br />
              ...
              <br /><br />
              Par ailleurs, nous n&apos;utilisons que des pratiques pour lesquelles il y a eu des études scientifiques et dont l&apos;efficacité ont été démontré. Pas d&apos;ésotérisme ou de croyances.
            </p>
          </div>
          <div className="grid gap-4 md:grid-cols-3">
